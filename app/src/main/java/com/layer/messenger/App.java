...
public class App extends Application {
    ...
    public LayerClient getLayerClient() {
        if (mLayerClient == null) {
            ...
            mLayerClient = generateLayerClient(optionsBuilder);
    ...
    private String getLayerAppId() {
        return (LAYER_APP_ID != null) ? LAYER_APP_ID : CustomEndpoint.getLayerAppId(this);
    }

    private LayerClient generateLayerClient(LayerClient.Options.Builder optionsBuilder) {
        String layerAppId = getLayerAppId();
        LayerClient.setLoggingEnabled(true);
        if (layerAppId == null) {
        ...
        optionsBuilder.useFirebaseCloudMessaging(true, null);
        CustomEndpoint.setLayerClientOptions(this, optionsBuilder);
        return LayerClient.newInstance(layerAppId, optionsBuilder.build());
    }
